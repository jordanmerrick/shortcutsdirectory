...
- [Back Up Workflows To iCloud](#back-up-workflows-to-icloud)
- [Create a Chart](#create-a-chart)
- [Create Gist](#create-gist)
- [Create GitHub Issue](#create-github-issue)
- [Create ZIP From Files](#create-zip-from-files)
- [Daily Health Report](#daily-health-report)
- [Days Between](#days-between)
- [Delete Completed Reminders](#delete-completed-reminders)
- [Device Screenshots files.zip](#device-screenshots-files-zip)
...
- [DigitalOcean: Get Droplets Info](#digitalocean--get-droplets-info)
...
- [OCR and Translate](#ocr-and-translate)
...
- [Share YouTube Clip at Specified Time](#share-youtube-clip-at-specified-time)
- [Simple Watermark](#simple-watermark)
- [Site Search](#site-search)
- [SOS](#sos)
- [Static Site Generator](#static-site-generator)
- [Stripe: Create a Customer](#stripe--create-a-customer)
- [Stripe: Create a Payment](#stripe--create-a-payment)
- [Stripe: Get Recent Charges](#stripe--get-recent-charges)
- [Subscribe with NewsBlur](#subscribe-with-newsblur)
- [TinEye Image](#tineye-image)
- [TinEye URL](#tineye-url)
- [Tip Calc](#tip-calc)
